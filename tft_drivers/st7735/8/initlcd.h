case ST7735_8:
	...
	UTFT_LCD_Write_DATA_8(0x1b); 
	UTFT_LCD_Write_DATA_8(0x0f);
	UTFT_LCD_Write_DATA_8(0x17); 
	UTFT_LCD_Write_DATA_8(0x33);
	UTFT_LCD_Write_DATA_8(0x2c); 
	UTFT_LCD_Write_DATA_8(0x29);
	UTFT_LCD_Write_DATA_8(0x2e); 
	...
	UTFT_LCD_Write_DATA_8(0x00);
	UTFT_LCD_Write_DATA_8(0x00);
	UTFT_LCD_Write_DATA_8(0x7f);
	UTFT_LCD_Write_COM(0x2b);
	UTFT_LCD_Write_DATA_8(0x00);
	UTFT_LCD_Write_DATA_8(0x00);
	UTFT_LCD_Write_DATA_8(0x00);
	UTFT_LCD_Write_DATA_8(0x9f);
