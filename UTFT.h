...
struct _current_font
{
	...
	uint8_t numchars;
		...
		void	UTFT(byte model, int RS, int WR, int CS, int _RST); // int SER = 0
...
extern regtype			*UTFT_P_RS, *UTFT_P_WR, *UTFT_P_CS, *UTFT_P_RST, *UTFT_P_SDA, *UTFT_P_SCL, *UTFT_P_ALE;
extern regsize			UTFT_B_RS, UTFT_B_WR, UTFT_B_CS, UTFT_B_RST, UTFT_B_SDA, UTFT_B_SCL, UTFT_B_ALE;
extern byte			UTFT___p1, UTFT___p2, UTFT___p3, UTFT___p4, UTFT___p5;
